...
#        self.base_path = "C:/Users/sting/Downloads/PocketSDR-master/PocketSDR-master/bin"
        ...
        style.configure("TLabelframe.Label", font=("Helvetica", 16, "bold"), background="#151b23", foreground="white")
        ...
        for i, label in enumerate(labels):
            self.status_labels[label] = tk.Label(self.status_frame, text=f"{label}: ", font=("Helvetica", 9, "bold"), width=67, bg="#1e272e", fg="white")
